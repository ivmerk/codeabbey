...
for (int i = 0; i < numbers; i++){
        ...
        cin >> king;
        cin >> queen;
        if ((king[0] == queen[0])||(king[1]==queen[1])||((int)king[0] ==  queen[0]+(queen[1]-king[1]))||((int)king[0] ==  queen[0]-(queen[1]-king[1])))
                resarr[i] = 'Y';
        char kingchar = king[0];
        int  kingint = king[1];
        char queenchar = queen[0];
        int queenint = queen[1];
