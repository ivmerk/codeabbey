/*My colleague have retold me this puzzle after visiting an interview at local office of Oracle company. I hope I remember it correctly.
...
for (int i = 0; i < numbers; i++){
        cin >> sp1 >> sp2 >> quant;
        for(int m = 1; m/sp1*1.0+m/sp2*1.0 < quant*1.0; m++ )
        resarr[i] = m + 1;
}
cout << "\n";
for (int i = 0; i < numbers; i++){
